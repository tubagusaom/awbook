<h4 class="fs-6 fw-bolder my-4 mb-3">Top Books  <a class="float-end text-primary text-decoration-underline" href="">
    <!-- <small class="fs-8">View All</small> -->
</a></h4>
                        ...
                        <div class="app-cover p-2 shadow-md bg-white">
                            <div class="row">
                                ...
                                <div class="det mt-2 col-8">
                                    <h5 class="mb-0 fs-6">Dinamika Industri Hulu</h5>
                                    <span class="fs-8">Industri</span>
                                    <ul class="row my-2">
                                        ...
                                        <li class="col-4"><span class="text-success fs-8 float-end">Detail</span></li>
                                    </ul>
                                    <b class="fs-8">Harga : 200.000</b>
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="single.php">
                          <div class="app-cover p-2 shadow-md bg-white">
                            <div class="row">
                                 ...
                                 <div class="det mt-2 col-8">
                                     <h5 class="mb-0 fs-6">Franchising Jesus<br>&nbsp;</h5>
                                     <span class="fs-8">Rohani</span>
                                     <ul class="row my-2">
                                         <li class="col-8 ratfac">
                                             <i class="bi text-warning bi-star-fill"></i>
                                             <i class="bi text-warning bi-star-fill"></i>
                    ...
                    <a href="single.php">
                        <div class="app-cover p-2 shadow-md bg-white">
                            <div class="row">
                                ...
                                <div class="det mt-2 col-8">
                                    <h5 class="mb-0 fs-6">Kebijakan Setengah Hati </h5>
                                    <span class="fs-8">Industri</span>
                                    <ul class="row my-2">
                                        <li class="col-8 ratfac">
                                            <i class="bi text-warning bi-star-fill"></i>
                    ...
                    <a href="single.php">
                      <div class="app-cover p-2 shadow-md bg-white">
                            <div class="row">
                                 ...
                                 <div class="det mt-2 col-8">
                                     <h5 class="mb-0 fs-6">Jeritan Energi<br>&nbsp;</h5>
                                     <span class="fs-8">Industri</span>
                                     <ul class="row my-2">
                                         <li class="col-8 ratfac">
                                             <i class="bi text-warning bi-star-fill"></i>
                       ...
                       <a href="single.php">
                          <div class="app-cover p-2 shadow-md bg-white">
                            <div class="row">
                                 ...
                                 <div class="det mt-2 col-8">
                                     <h5 class="mb-0 fs-6">Profil Industri Keramik Indonesia</h5>
                                     <span class="fs-8">Industri</span>
                                     <ul class="row my-2">
                                         <li class="col-8 ratfac">
                                             <i class="bi text-warning bi-star-fill"></i>
